...
#define X_HOME_STEPS 900  // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1800 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
#define Z_HOME_STEPS 3780 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
...
#define STEPS_PER_REV 200 // NEMA17 STEPS PER REVOLUTIONw
...
#define RAIL_LENGTH 700.0 // MAX LENGTH OF RAIL IN MM
...
//GRIPPER SETTINGS
// 只保留SERVO相关定义
#define GRIPPER 1 // 1: 9G SERVO OR MG996 SERVO EQUIVALENT
#define SERVO 1
