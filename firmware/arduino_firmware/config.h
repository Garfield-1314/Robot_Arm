...
#define X_HOME_STEPS 900 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1940 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
#define Z_HOME_STEPS 3610 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
